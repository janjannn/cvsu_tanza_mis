...
@section('content')
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="#"
                               onclick="showDashboardContent('faculties'); return false;">{{ __('View Faculties') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/printreport"
                               onclick="showDashboardContent('print_report'); return false;">{{ __('Print Report') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#"
                               onclick="showDashboardContent('academic_year'); return false;">{{ __('Set Academic Year/Quarter') }}</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#"
                               onclick="showDashboardContent('email_reminder'); return false;">{{ __('Email Reminder') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#"
                               onclick="showDashboardContent('view_reports'); return false;">{{ __('View Reports') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#"
                               onclick="showDashboardContent('view_form'); return false;">{{ __('View Form') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#"
                               onclick="showDashboardContent('users_sched'); return false;">{{ __('Users Schedule') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#"
                               onclick="showDashboardContent('dtrform'); return false;">{{ __('DTR Form') }}</a>
                        </li>
                        <li class="nav-item">
    ...
    <script>
        ...
        const clipboardJs = new ClipboardJS('.clipboard');
        ...
        async function printPdf(id) {
            ...
            const downloadBtn = document.querySelector(`#download${id}`);
            const defaultHtml = downloadBtn.innerHTML;

            try {

                downloadBtn.innerHTML = "<div class='spinner-border' role='status'><span class='sr-only'></span></div>"

                const data = await fetch(downloadBtn.dataset.download);
